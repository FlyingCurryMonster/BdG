...
ground_state_wavefunction = eigenvectors(:,1) + 1*eigenvalues(1,1)*ones(number_of_data_points,1);
first_excited_state = eigenvectors(:,2) + 1*eigenvalues(2,2)*ones(number_of_data_points,1);
second_excited_state = eigenvectors(:,3) + 1*eigenvalues(3,3)*ones(number_of_data_points,1);
